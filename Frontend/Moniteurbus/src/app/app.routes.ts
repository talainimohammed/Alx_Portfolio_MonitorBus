...
export const routes: Routes = [
  ...
  { path: 'ecole/:id', component: EcoleComponent,canActivate:[AuthGuardService],data:{role:['ADMINISTRATEUR', 'Ecole', 'CHAUFFEUR','PARENT']} },
  ...
  { path: 'etudloc/:id', component: EtudiantLocalisationComponent,canActivate:[AuthGuardService],data:{role:['ADMINISTRATEUR', 'CHAUFFEUR','Ecole']} },
